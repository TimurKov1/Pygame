...
class Water(pygame.sprite.Sprite):
    def __init__(self, all_sprites):
        ...
        self.frames = [load_image(f"Characters/Water/Idle/{i + 1}.png") for i in range(len(os.listdir("./Sprites/Characters/Water/Idle")))]
    ...
    def update(self):
        ...
        if self.isJump:
            if self.jumpCount == 15:
                self.current_frame = 0
            if self.jumpCount >= 0:
                self.change_frames("Characters/Water/Jump", 5)
                ...
                self.change_frames("Characters/Water/Fall", 5)
                self.current_frame = (self.current_frame + 1) % len(self.frames)
                if self.direction == 'right':
                    self.image = pygame.transform.scale(self.frames[self.current_frame], (self.frames[self.current_frame].get_width() * 3, self.frames[self.current_frame].get_height() * 3))
                else:
        ...
        if self.isAttack and (not self.isJump):
            ...
            if self.attackCount == len(self.frames):
                ...
                self.power -= 7
                return
            self.change_frames("Characters/Water/Attack1", 4)
            if self.direction == 'right':
            ...
            if self.attackCount == len(self.frames):
                ...
                self.power -= 25
                return
            self.change_frames("Characters/Water/Attack2", 4)
            if self.direction == 'right':
                self.image = pygame.transform.scale(self.frames[self.attackCount], (self.frames[self.attackCount].get_width() * 3, self.frames[self.attackCount].get_height() * 3))
            else:
                self.image = pygame.transform.flip(pygame.transform.scale(self.frames[self.attackCount], (self.frames[self.attackCount].get_width() * 3, self.frames[self.attackCount].get_height() * 3)), True, False)
            ...
            if self.attackCount == len(self.frames):
                ...
                self.power -= 50
                return
            self.change_frames("Characters/Water/Attack3", 4)
            if self.direction == 'right':
                self.image = pygame.transform.scale(self.frames[self.attackCount], (self.frames[self.attackCount].get_width() * 3, self.frames[self.attackCount].get_height() * 3))
            else:
                self.image = pygame.transform.flip(pygame.transform.scale(self.frames[self.attackCount], (self.frames[self.attackCount].get_width() * 3, self.frames[self.attackCount].get_height() * 3)), True, False)
            ...
            if self.type == 'idle':
                if not self.isJump:
                    self.change_frames("Characters/Water/Idle", 5)
                    self.current_frame = (self.current_frame + 1) % len(self.frames)
                    if self.direction == 'right':
                        self.image = pygame.transform.scale(self.frames[self.current_frame], (self.frames[self.current_frame].get_width() * 3, self.frames[self.current_frame].get_height() * 3))
                    else:
            ...
            if self.type == 'run_right':
                if not self.isJump:
                    self.change_frames("Characters/Water/Run", 4)
                    self.current_frame = (self.current_frame + 1) % len(self.frames)
                    self.image = pygame.transform.scale(self.frames[self.current_frame], (self.frames[self.current_frame].get_width() * 3, self.frames[self.current_frame].get_height() * 3))
